...
| `handoff-to-github` | `skills/engineering/handoff-to-github` | Creates GitHub issue handoffs from explicit Markdown task headings or lists, uploads task and ADR/spec files to Gists, and adds each issue to a verified GitHub Project. |
