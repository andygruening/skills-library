...
| `manage-github-project` | `skills/engineering/manage-github-project` | Manages repository-scoped GitHub Project boards with `gh`, including stage scans, issue triage, status moves, comments, reactions, and issue edits. |
