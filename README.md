...
| `design-architect` | `skills/engineering/design-architect` | Generates design-system code, tokens, wrappers, variants, layouts, and checked example metadata for iOS SwiftUI, Android Jetpack Compose/Kotlin, and React TypeScript web apps. |
